...
namespace MvcWepApp2.Models
{
    public class Egitmen:ModelBase
    {
        ...
        public bool GirisYap()
        {
            ...
            DataTable dt = data.GetExecuteDataTable("Select * from Egitmen where EgitmenAdi=@egitmenadi and EgitmenSifre=@egitmensifre",
                CommandType.Text,
                new SqlParameter("@egitmenadi", Ad),
                new SqlParameter("@egitmensifre", Sifre));
